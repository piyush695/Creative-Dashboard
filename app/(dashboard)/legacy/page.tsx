...
import { fetchAdsFromMongo, fetchGoogleAdsFromMongo, fetchAdDetailById } from "@/server/actions/ads";
            ...
            {activeView === "ai-studio" ? (
              ...
              <CreativeHistoryView
                ...
                onRegenerate={(payload) => {
                  // Legacy studio shows a single result — use the latest turn.
                  const msgs = payload.messages || [];
                  const lastAssistant = [...msgs].reverse().find((m) => m.role === "assistant");
                  const lastUser = [...msgs].reverse().find((m) => m.role === "user");
                  setStudioPrompt(lastUser?.text || lastAssistant?.prompt || "");
                  setStudioResult(lastAssistant?.result || null);
                  setStudioTab(payload.tab || '');
                  setStudioGenOptions(null);
