...
const buttonVariants = cva(
  // NOTE: no `disabled:pointer-events-none` — the native `disabled` attribute
  // already blocks clicks, and pointer-events:none would suppress the
  // `disabled:cursor-not-allowed` feedback on hover.
