...
export default function GoogleAdsView({
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700 pb-20 overflow-hidden max-w-full">
                        ...
                        <Card className="lg:col-span-4 p-6 md:p-8 border border-border bg-white/80 dark:bg-card/80 md:backdrop-blur-xl backdrop-blur-md shadow-sm rounded-md relative overflow-hidden group">
                            ...
                            <div className="flex flex-col items-center justify-center py-2 md:py-4">
                                ...
                                <div className="mt-8 md:mt-10 w-full space-y-4">
                                    ...
                                    <Button className="w-full h-11 md:h-12 rounded-md bg-[#1a73e8] hover:bg-[#1557b0] text-white font-black text-xs md:text-sm tracking-tight shadow-sm transition-all">Review key shifts</Button>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6 md:p-8 border border-border bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-sm rounded-md flex flex-col min-h-[450px] lg:h-[520px]">
                            ...
                            <div className="space-y-3 flex-1 overflow-y-auto pr-1 custom-scrollbar">
                                {typeBreakdown.map((item, i) => {
                                    ...
                                    return (
                                        <div key={item.type} className="p-3.5 rounded-md bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-border group hover:border-[#1a73e8]/30 transition-all">
                                                ...
                                                <TableRow key={`${kw.word}-${i}`} className="border-none group/kw hover:bg-[#1a73e8]/5 transition-colors">
                                                    <TableCell className="py-4 pl-0">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <span className="text-[10px] md:text-[11px] font-semibold text-foreground/80 dark:text-zinc-300 group-hover/kw:text-[#1a73e8] transition-colors tracking-tight break-all">{kw.word}</span>
                                                        </div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell colSpan={3} className="pt-16 pb-12 text-center border-none hover:bg-transparent">
                                                        <div className="flex flex-col items-center justify-center space-y-5 max-w-[200px] mx-auto group">
                                                            <div className="relative">
                                                                ...
                                                                <div className="relative h-16 w-16 rounded-md bg-white dark:bg-zinc-800/80 border border-border/50 dark:border-border shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:-translate-y-1 transition-all duration-500">
                                                                    <Search className="h-6 w-6 text-[#1a73e8]" />
                                                                    <div className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-card border border-border shadow-md flex items-center justify-center animate-bounce delay-150">
                                                            ...
                                                            <div className="space-y-1 opacity-90 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                                                <p className="text-[11px] font-black tracking-widest text-foreground uppercase">No Signals Detected</p>
                                                                <p className="text-[9px] font-bold tracking-widest text-muted-foreground uppercase">Awaiting keyword data sync</p>
                                                            </div>
                                                        </div>
                                                    </TableCell>
                                                </TableRow>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card className="p-6 md:p-8 border border-border bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-sm rounded-md relative overflow-hidden group">
                            ...
                            <div className="grid grid-cols-2 gap-4 relative z-10">
                                {[
                                    ...
                                    return (
                                        <div key={trigger.label} className="p-4 md:p-5 rounded-md bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-border group/trig hover:border-purple-500/30 transition-all hover:bg-white dark:hover:bg-white/10 shadow-sm hover:shadow-sm">
                        ...
                        <Card className="p-6 md:p-8 border border-border bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-sm rounded-md relative overflow-hidden group">
                            ...
                            <div className="flex items-center justify-between mb-6 relative z-10">
                                <div>
                                    <h3 className="text-lg md:text-xl font-black tracking-tight text-foreground">Behavioral Triggers</h3>
                            ...
                            {recommendations.length > 0 ? recommendations.map((rec, i) => (
                                    ...
                                    <div className="flex flex-col h-full relative z-10">
                                        ...
                                        <div className="space-y-3 md:space-y-4 flex-1">
                                            <div className="space-y-1.5 md:space-y-2">
                                                ...
                                                <h4 className="text-sm md:text-base font-black text-foreground leading-tight tracking-tight group-hover/rec:text-[#1a73e8] transition-colors line-clamp-2">
                                                    {rec.title}
                                                </h4>
                                            </div>
                                ...
                                <div className="col-span-full py-16 flex flex-col items-center justify-center text-center group">
                                    <div className="relative">
                                        ...
                                        <div className="relative h-20 w-20 rounded-md bg-white dark:bg-zinc-800/80 border border-border/50 dark:border-border shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-500">
                                            <Activity className="h-8 w-8 text-[#1a73e8]" />
                                            <div className="absolute -bottom-2 -right-2 h-7 w-7 rounded-full bg-card border border-border shadow-lg flex items-center justify-center animate-bounce delay-150">
                                                <div className="h-2 w-2 rounded-full bg-[#1a73e8]" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-1.5 mt-6 opacity-90 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                        <h3 className="text-xs font-black text-foreground uppercase tracking-tight">No Strategic Shifts Detected Yet</h3>
                                        <p className="text-[9px] text-muted-foreground font-bold uppercase tracking-[0.15em]">Our analyzer needs more diverse data segments</p>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="space-y-8 pt-4">
                        <div className="flex items-center justify-between px-2">
                            ...
                            <Button
                                variant="ghost"
                                size="icon"
                                className="md:hidden h-10 w-10 rounded-xl bg-muted text-[#1a73e8]"
                                onClick={() => setActiveTab("ads")}
                            >
                            ...
                            {filteredAds.slice(0, cardLimit).map((ad, i) => (
                                <Card key={ad.id} className="min-w-[280px] md:min-w-0 w-[280px] md:w-full bg-white dark:bg-[#09090b] border border-border hover:border-zinc-300 dark:hover:border-zinc-700 rounded-md p-3.5 flex flex-col gap-4 group shadow-sm transition-all duration-300 snap-center flex-shrink-0 md:flex-shrink-1">
                                    ...
                                    <div className="flex items-center justify-between gap-2 px-1">
                                        <h3 className="text-foreground font-bold text-[14px] leading-tight truncate flex-1">{ad.adName}</h3>
                                    </div>

                                    {/* Stats Grid - MATCHING REFERENCE */}
                                    <div className="grid grid-cols-2 gap-3">
                                        {/* Spend Box */}
                                        <div className="bg-card/50 rounded-md p-2.5 border border-zinc-100 dark:border-border/50 flex flex-col justify-between h-[75px] group/spend transition-all hover:bg-zinc-100 dark:hover:bg-card">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <p className="text-[9px] text-muted-foreground font-black">Spend</p>
                                            </div>
                                            <p className="text-[17px] font-black text-foreground tracking-tight">${Number(ad.spend).toLocaleString()}</p>
                                        </div>
                                ...
                                <TableHeader>
                                    <TableRow className="bg-[#f8f9fa] dark:bg-white/5 hover:bg-[#f8f9fa] dark:hover:bg-white/5 transition-none border-b border-border">
                                        <TableHead className="w-[40px] px-6 text-center hidden lg:table-cell">
                                            <input type="checkbox" className="w-4 h-4 rounded border-zinc-300 dark:border-border text-[#1a73e8]" />
                                        </TableHead>
                                        <TableHead className="w-auto text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest px-4 py-4">Campaign</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-center px-1 hidden md:table-cell">Status</TableHead>
                                        <TableHead className="w-[80px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1 hidden md:table-cell">Ads</TableHead>
                                        <TableHead className="w-[90px] md:w-[120px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1">Cost</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1 hidden lg:table-cell">Impr.</TableHead>
                                            ...
                                            <TableRow key={camp.name} className="group/row hover:bg-blue-50/30 dark:hover:bg-blue-900/5 cursor-pointer border-b border-zinc-100 dark:border-border transition-all duration-300">
                                                ...
                                                <TableCell className="px-6 py-4">
                                                    <div className="flex flex-col w-full min-w-0 max-w-[150px] md:max-w-[220px] lg:max-w-[350px] xl:max-w-[500px]">
                                                        <span className="text-foreground font-semibold text-[13px] md:text-[14px] group-hover/row:text-[#1a73e8] transition-colors truncate block leading-tight">{camp.name}</span>
                                                        <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-tight mt-0.5 opacity-70 truncate block">Analytics</span>
                                                    </div>
                                                </TableCell>
                            ...
                            <Table className="w-full min-w-[600px] md:min-w-full">
                                <TableHeader>
                                    <TableRow className="bg-[#f8f9fa] dark:bg-white/5 hover:bg-[#f8f9fa] dark:hover:bg-white/5 transition-none border-b border-border">
                                        ...
                                        <TableHead className="w-auto text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest px-4 py-4">Keyword</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-center px-1">Match</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1">Spend</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1 hidden md:table-cell">Impr.</TableHead>
                                        <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-right px-1 hidden md:table-cell">Clicks</TableHead>
                                            ...
                                            <TableCell colSpan={7} className="h-[400px] text-center border-none p-0 relative hover:bg-transparent">
                                                <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                                                    <div className="flex flex-col items-center justify-center space-y-6 max-w-sm mx-auto group w-full">
                                                        <div className="relative">
                                                            <div className="absolute inset-0 bg-[#1a73e8]/10 blur-3xl rounded-full scale-[2] opacity-0 group-hover:opacity-40 transition-opacity duration-700" />
                                                            <div className="relative h-20 w-20 md:h-24 md:w-24 rounded-md md:rounded-md bg-white dark:bg-zinc-800/80 border border-border/50 dark:border-border shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-500">
                                                                <Search className="h-8 w-8 md:h-10 md:w-10 text-[#1a73e8] bg-clip-text" />
                                                                <div className="absolute -bottom-2 -right-2 h-6 w-6 md:h-8 md:w-8 rounded-full bg-card border border-border shadow-lg flex items-center justify-center animate-bounce delay-150">
                                                        ...
                                                        <div className="space-y-1.5 opacity-90 group-hover:opacity-100 transition-opacity duration-500 delay-100 text-center">
                                                            <h3 className="text-base md:text-lg font-black text-foreground uppercase tracking-tight">No Keyword Data Found</h3>
                                                            <p className="text-[9px] md:text-[10px] text-muted-foreground font-bold uppercase tracking-[0.2em] px-4">Adjust filters or tags to analyze signals</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableRow key={`${kw.word}-${i}`} className="group/row hover:bg-blue-50/30 dark:hover:bg-blue-900/5 cursor-pointer border-b border-zinc-100 dark:border-border transition-all duration-300">
                                                ...
                                                <TableCell className="px-4 py-4">
                                                    <div className="w-full min-w-0">
                                                        <span className="text-foreground font-semibold text-[12px] md:text-[13px] group-hover/row:text-[#1a73e8] transition-colors uppercase tracking-tight truncate block leading-tight">{kw.word}</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell className="text-center font-bold text-[10px] text-muted-foreground uppercase tracking-widest px-1">Broad</TableCell>
                                                <TableCell className="text-right font-black text-[12px] md:text-[13px] text-foreground px-1">${kw.spend.toLocaleString()}</TableCell>
                                                <TableCell className="text-right font-bold text-[11px] md:text-[12px] text-muted-foreground dark:text-muted-foreground px-1 hidden md:table-cell">{kw.impr.toLocaleString()}</TableCell>
                                                <TableCell className="text-right font-bold text-[11px] md:text-[12px] text-muted-foreground dark:text-muted-foreground px-1 hidden md:table-cell">{kw.clicks.toLocaleString()}</TableCell>
                            ...
                            <TableHeader>
                                <TableRow className="bg-[#f8f9fa] dark:bg-white/5 hover:bg-[#f8f9fa] dark:hover:bg-white/5 transition-none border-b border-border">
                                    <TableHead className="w-[40px] px-4 text-center hidden lg:table-cell">
                                        <input type="checkbox" className="w-4 h-4 rounded border-zinc-300 dark:border-border text-[#1a73e8] focus:ring-[#1a73e8]" />
                                    </TableHead>
                                    <TableHead className="w-[60px] md:w-[80px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest px-2">Ad</TableHead>
                                    <TableHead className="w-auto text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest px-2">Details</TableHead>
                                    <TableHead className="w-[100px] text-muted-foreground dark:text-muted-foreground font-black text-[9px] uppercase tracking-widest text-center px-4 hidden md:table-cell">Status</TableHead>
                                        ...
                                        <TableCell colSpan={9} className="h-[400px] text-center border-none p-0 relative">
                                            <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                                                <div className="flex flex-col items-center justify-center space-y-6 max-w-sm mx-auto group w-full">
                                                    ...
                                                    <div className="space-y-1.5 opacity-90 group-hover:opacity-100 transition-opacity duration-500 delay-100 text-center">
                                                        <h3 className="text-base md:text-lg font-black text-foreground uppercase tracking-tight">No Matching Creatives</h3>
                                                        <p className="text-[9px] md:text-[10px] text-muted-foreground font-bold uppercase tracking-[0.2em] px-4">Adjust filters to see more results</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </TableCell>
                                        ...
                                        {filteredAds.slice(0, displayLimit).map((ad) => (
                                            ...
                                            >
                                                <TableCell className="px-4 text-center hidden lg:table-cell">
                                                    <input type="checkbox" className="w-4 h-4 rounded border-zinc-300 dark:border-border text-[#1a73e8] focus:ring-[#1a73e8]" onClick={(e) => e.stopPropagation()} />
                                                </TableCell>
                                                ...
                                                <TableCell className="px-4">
                                                    <div className="flex flex-col min-w-0 md:max-w-[200px]">
                                                        <span className="text-foreground font-semibold text-[12px] md:text-[12px] truncate leading-tight block">{ad.adName || "Unnamed"}</span>
                                                        <span className="text-[10px] text-muted-foreground font-bold truncate opacity-80 block">{ad.campaignName}</span>
                                                    </div>
                                                </TableCell>
    ...
    return (
        <TooltipProvider>
                    ...
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col min-w-0 gap-0.5">
                                ...
                                <h1 className="text-[13px] font-black tracking-tight text-foreground truncate leading-tight">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="h-8 px-2.5 bg-card border-border rounded-lg flex items-center gap-2">
                                    {dataSource === "database" ? <Database className="h-3 w-3 text-[#1a73e8]" /> : <Wifi className="h-3 w-3 text-[#1a73e8] animate-pulse" />}
                                    <span className="text-[10px] font-bold text-foreground/80 dark:text-zinc-300">{dataSource === "database" ? "Historical" : "Live"}</span>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="start" className="w-52 rounded-md p-2 bg-white/95 dark:bg-card/95 backdrop-blur-xl border-border shadow-sm z-[100]">
                            ...
                            <div className="flex items-center gap-2 group/acc cursor-pointer">
                                <h1 className="text-sm font-black tracking-tight text-foreground group-hover/acc:text-[#1a73e8] transition-colors flex items-center gap-1.5 truncate">
                                    {selectedAccountId !== "all"
                                        ? (googleAds.find(a => a.adAccountId === selectedAccountId)?.accountName || "Account")
                                        : "Global Overview"}
                                    <ChevronDown className="h-3 w-3 text-muted-foreground group-hover/acc:translate-y-0.5 transition-transform shrink-0" />
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 lg:gap-3 justify-end">
                        ...
                        {dataSource === "realtime" && (
                            <div className="bg-card/40 border border-border rounded-xl px-1 shadow-sm relative group w-full md:max-w-[260px] transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800 h-9 flex items-center mr-auto lg:mr-0">
                                ...
                                />
                                {realtimeSearchQuery && (
                                    <button onClick={() => setRealtimeSearchQuery('')} className="absolute right-2.5 text-muted-foreground hover:text-muted-foreground dark:hover:text-zinc-200 transition-colors">
            ...
            {dataSource !== "realtime" && (
                <div className="bg-white/40 dark:bg-black/40 backdrop-blur-sm border-b border-border px-4 md:px-8">
                    <div className="flex items-center gap-6 md:gap-10 overflow-x-auto scrollbar-none">
                        {tabs.map((tab) => (
                            ...
                            >
                                <tab.icon className={cn("h-3.5 w-3.5", activeTab === tab.id ? "text-[#1a73e8]" : "text-muted-foreground")} />
                                <span className={cn(
            ...
            {dataSource === "realtime" ? (
                <div className="flex flex-col w-full px-2 md:px-4 py-4">
                    <div className="bg-white dark:bg-black/40 border border-border rounded-md overflow-hidden shadow-sm" style={{ height: "calc(100vh - 160px)" }}>
                        <RealtimeNativeView
                            ...
                            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 overflow-x-auto pb-1 md:pb-0 [&::-webkit-scrollbar]:hidden scroll-smooth flex-nowrap">
                                    ...
                                    <div className="flex-none flex items-center gap-1 ml-auto lg:hidden">
                                        <Button variant="ghost" size="icon" className="h-10 w-10 text-muted-foreground rounded-xl hover:bg-zinc-100 dark:hover:bg-white/5"><Columns className="h-4 w-4" /></Button>
                                        <Button variant="ghost" size="icon" className="h-10 w-10 text-muted-foreground rounded-xl hover:bg-zinc-100 dark:hover:bg-white/5"><Download className="h-4 w-4" /></Button>
                                    </div>
                                </div>
                            </div>
