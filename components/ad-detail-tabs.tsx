                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-7 relative z-10 w-full">
                    ...
                    <div className="flex-1 space-y-2 md:space-y-3 text-center md:text-left w-full min-w-0">
                        <div className="flex items-center justify-center md:justify-start gap-2">
                            ...
                            <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest">{adData.platform || "Google"} Ads</span>
                        </div>
                        <h2 className="text-xl md:text-3xl font-black tracking-tighter text-foreground italic leading-tight truncate px-2 md:px-0">
                            {adData.adName}
                        </h2>
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 md:gap-3">
                            <div className="flex items-center gap-1.5 px-3 py-1 bg-zinc-100 dark:bg-white/5 rounded-full border border-border">
                                <span className="text-[10px] font-black text-muted-foreground leading-none">ID:</span>
                                <span className="text-[10px] font-bold text-muted-foreground dark:text-zinc-300 font-mono tracking-tighter leading-none">{adData.adId}</span>
                            </div>
                            <div className="flex items-center gap-1.5 px-3 py-1 bg-zinc-100 dark:bg-white/5 rounded-full border border-border max-w-[200px] md:max-w-[400px] lg:max-w-[600px] pr-8">
                                <span className="text-[10px] font-black text-muted-foreground leading-none">Campaign:</span>
                                <span className="text-[10px] font-bold text-muted-foreground dark:text-zinc-300 truncate leading-none">{adData.campaignName}</span>
                            </div>
                        </div>
                </div>
                </div>
                    ...
                    <Card className="p-8 border border-border bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-sm rounded-md relative overflow-hidden group">
                        ...
                        <div className="relative z-10 h-full flex flex-col">
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <h3 className="text-xl font-semibold tracking-tight">Design footprint</h3>
                            </div>
