      ...
      <Card className="relative overflow-hidden border border-border bg-card transition-colors group rounded-md">
        ...
        <CardHeader className="pb-2 px-8 pt-8">
          <div className="flex gap-4 items-center">
            <div className="p-3 rounded-md bg-primary/10 shadow-inner">
        ...
        <Card className="border border-border bg-card relative overflow-hidden group rounded-md">
          ...
          <CardContent className="px-8 pb-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="space-y-4 p-8 rounded-md bg-zinc-50 dark:bg-white/5 border border-border dark:border-border transition-all hover:bg-white dark:hover:bg-white/10 hover:shadow-sm hover:border-emerald-500/30 duration-500">
              ...
              <div className="space-y-4 p-8 rounded-md bg-zinc-50 dark:bg-white/5 border border-border dark:border-border transition-all hover:bg-white dark:hover:bg-white/10 hover:shadow-sm hover:border-amber-500/30 duration-500">
                <div className="flex items-center gap-3 mb-1">
              ...
              <div className="space-y-4 p-8 rounded-md bg-zinc-50 dark:bg-white/5 border border-border dark:border-border transition-all hover:bg-white dark:hover:bg-white/10 hover:shadow-sm hover:border-primary/30 duration-500">
                <div className="flex items-center gap-3 mb-1">
            ...
            <div key={idx} className="flex flex-col gap-4 p-6 rounded-md bg-card border border-border hover:bg-accent transition-colors group/rec">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-shrink-0">
                  <span className="flex items-center justify-center w-12 h-12 rounded-md bg-primary text-white text-lg font-black shadow-sm shadow-primary/30 group-hover/rec:scale-110 transition-all duration-500">
                    {idx + 1}
                  </span>
                </div>
                <div className="flex-1 space-y-6">
                  ...
                  <div className="flex flex-wrap gap-3 items-stretch">
                    {rec.impact && (
                      <div className="flex flex-col gap-1 min-w-[200px] flex-1 px-4 py-3 bg-primary/5 dark:bg-primary/10 rounded-md border border-primary/10 transition-all hover:scale-[1.02] cursor-default">
                        <span className="text-[10px] font-medium uppercase tracking-wider text-primary/60">Expected Performance Impact</span>
                        <span className="text-xs font-bold text-foreground/80 dark:text-zinc-200 leading-tight">{rec.impact}</span>
                      </div>
                    )}
                    {rec.effort && (
                      <div className="flex flex-col gap-1 px-4 py-3 bg-secondary dark:bg-zinc-800 rounded-md border border-border dark:border-zinc-700 shrink-0 transition-all hover:scale-[1.02] cursor-default">
                        <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground/60">Implementation Effort</span>
